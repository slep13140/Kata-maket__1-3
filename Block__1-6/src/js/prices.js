...
function mobileSlider () {
  if (window.innerWidth <= initSize && swipPrice.dataset.mobile == 'false') {
    ...
    swipPrice.dataset.mobile = 'true';

    if (swipPrice.classList.contains('swiper-initialized')) {
      addPriceSlide ();      
      removePriceTable ();
    }
  };
  ...
  if (window.innerWidth > initSize) {
    swipPrice.dataset.mobile = 'false';
    if (swipPrice.classList.contains('swiper-initialized')) {
